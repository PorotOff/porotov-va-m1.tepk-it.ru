...
<?php $this->beginPage() ?>
    ...
    <header id="header">
        ...
        if (Yii::$app->user->isGuest) {
            ...
            // Вкладка "Карточки продукции" всегда доступна
            $menuItems[] = [
    ...
    <footer id="footer" class="mt-auto py-3 bg-light">
        <div class="container">
            <div class="row text-muted">
                <div class="col-md-6 text-center text-md-start">&copy; My Cockpany <?= date('Y') ?></div>
                <div class="col-md-6 text-center text-md-end">Разработано Поротовым Всеволодом: <a href="https://github.com/PorotOff/porotov-va-m1.tepk-it.ru">Ссылка на гитхаб</a></div>
            </div>
        </div>
    </footer>
